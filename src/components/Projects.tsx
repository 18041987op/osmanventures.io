...
const projects: Project[] = [
  ...
  },
  {
    ...
    image: "/images/ulua.jpg",
    gradient: "from-emerald-600/20 to-cyan-600/20",
    isOwnProduct: true,
  },
  {
    title: "EL BOTÓN — Mini Games",
    description:
      "Bilingual (ES/EN) neon arcade platform with quick-session mini-games. Progress system with levels, streaks, coins and daily rewards, plus a global leaderboard — installable as a PWA.",
    tech: ["React", "Vite", "Supabase", "PWA"],
    url: "https://games.osmanventures.io",
    features: [
      "Neon arcade mini-games",
      "Levels, streaks & coins",
      "Daily rewards & missions",
      "Global leaderboard",
      "Local 1-2 player mode",
      "Installable PWA (ES/EN)",
    ],
    image: "/images/games.jpg",
    gradient: "from-violet-600/25 to-rose-600/25",
    isOwnProduct: true,
  },
  {
    title: "AR-CHomes.com",
